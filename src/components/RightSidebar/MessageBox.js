...
//This component is for Message Box
  ...
  return (
    <>
      <div className="message-box">
        ...
        {chat.length === 0 && (
          <p className="no-message-alert">There are no messages yet..</p>
        )}
        {chat.length > 0 && (
            ...
            {chat.map((m, index) =>
              m.sender === "me" ? (
                <RightChatBubble
                  ...
                  key={index}
                  name={"Waseem Akram"}
                  image={"https://img.freepik.com/premium-photo/close-up-smiling-businessman-standing-front-modern-office-buildings_51195-4689.jpg"}
                />
              ) : (
                <LeftChatBubble
                  message={m}
